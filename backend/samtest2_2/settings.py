"""
Django settings for samtest2_2 project.
...
WSGI_APPLICATION = 'samtest2_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtest2_2 API",
    "DESCRIPTION": "API documentation for samtest2_2 App",
    "VERSION": "v1",
}
